...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats(await responses[0].json());
      setBookings(await responses[1].json());
      setUsers(await responses[2].json());
      setFacilityStats(await responses[3].json());
      setCruises(await responses[4].json());
